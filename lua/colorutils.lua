 ...
 if (sub1 > epsilon) then sub2 = sub1 else sub2 = (l / kappa) end
 for i = 1, 3 do
 local m1 = m[i][1]
 local m2 = m[i][2]
 local m3 = m[i][3]
 ...
 if (L <= 8) then return ((refY * L) / kappa) else return (refY * (((L + 16) / 116) ^ 3)) end end

 local function from_linear(c)
 if (c <= 0.0031308) then return (12.92 * c) else return ((1.055 * (c ^ 0.41666666666667)) - 0.055) end end

 local function to_linear(c)
 if (c > 0.04045) then return (((c + 0.055) / 1.055) ^ 2.4) else return (c / 12.92) end end
 ...
 return (start + (i * (stop - start))) end return _16_ end
 ...
 return ((360 + math.deg((start + (delta * i)))) % 360) end return _17_ end
